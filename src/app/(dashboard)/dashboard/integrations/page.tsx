...
const CHANNEL_TYPES: ChannelInfo[] = [
  ...
  },
  {
    ...
    name: "Instagram DM",
    icon: "📸",
    description: "Connectez votre compte Instagram professionnel. L'Access Token suffit — votre webhook est unique.",
    fields: [
      {
        name: "instagramId",
        ...
        helpText: "ID du compte Instagram Business (Meta Business Suite > Comptes Instagram). Obligatoire.",
      },
      {
        name: "accessToken",
        ...
        type: "password",
        placeholder: "EAAx...",
        helpText: "Token d'accès de la Page Facebook liée à Instagram. Commence par 'EAA'.",
      },
    ],
  },
  {
    ...
    icon: "💬",
    description: "Connectez votre Page Facebook Messenger. Seuls l'Access Token et l'App Secret sont nécessaires.",
    fields: [
      {
        name: "accessToken",
        label: "Facebook Page Access Token",
      ...
      },
      {
        ...
        type: "password",
        placeholder: "abc123...",
        helpText: "Secret de votre app Meta Developer (Meta Developer Portal > App > Settings > Basic).",
      },
    ],
  },
  {
